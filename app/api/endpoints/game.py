        ...
        while True:
            try:
                ...
                # Handle player submissions
                    ...
                    if (player.last_submission is not None and current_time - player.last_submission < submission_cooldown):
                    ...
                    if result["success"]:
                        ...
                        await game_state.player1.send_event(GameEvent(
                            type="game_state",
                            data=game_manager.create_game_view(game_state, game_state.player1.user_id).model_dump()
                        ))

                        await game_state.player2.send_event(GameEvent(
                            type="game_state",
                            data=game_manager.create_game_view(game_state, game_state.player2.user_id).model_dump()
                        ))
