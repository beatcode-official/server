...
class Problem(Base):
    ...
    boilerplate = relationship(
        "Boilerplate", back_populates="problem", uselist=False, lazy="joined"
    )
    compare_func = relationship(
        "CompareFunc", back_populates="problem", uselist=False, lazy="joined"
    )
